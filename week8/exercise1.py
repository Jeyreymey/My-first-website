...
def put_behind_bars(input_string="very naughty boy"):
    ...
    """
    word_bars = []
    word_bars.join(['|{}|'.format(x) for x in s])
    return word_bars
...
def make_filler_text_dictionary():
    ...
    """
    import requests
    url = "http://www.setgetgo.com/randomword/?argName=argVal"
